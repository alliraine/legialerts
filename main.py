...
def update_worksheet(year, worksheet, new_title, change_title, rollover = False):
    ...
    for index, row in gsheet.iterrows():
        try:
            ...
            gsheet.at[index, 'Youth State Risk'] = f"=VLOOKUP(A{index+2},'Risk Levels'!$A$4:$E$55,2)"
            gsheet.at[index, 'Adult State Risk'] = f"=VLOOKUP(A{index+2},'Risk Levels'!$A$4:$E$55,3)"
